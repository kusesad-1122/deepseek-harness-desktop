...
export default defineConfig([
  {
    ...
    entry: {
      ...
      'knowledge-routes': 'src/knowledge-routes.ts',
      'reasoning-default': 'src/reasoning-default.ts',
  ...
  {
    name: `${PACKAGE_NAME}/memory-web`,
    entry: { 'memory-web': 'src/memory-web.ts' },
  ...
  {
    name: `${PACKAGE_NAME}/knowledge-web`,
    entry: { 'knowledge-web': 'src/knowledge-web.ts' },
    tsconfig: 'tsconfig.client.json',
    outDir: 'lib',
    format: 'esm',
    platform: 'browser',
